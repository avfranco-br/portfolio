...
| 3 | Speckit templates underused | `.specify/templates/` exists from bootstrap but is rarely used | Decide: adopt templates for new specs, or deprecate the framework |
...
| 7 | `.gemini/` directory present | Bootstrap artefact | Confirm whether to keep or remove |
